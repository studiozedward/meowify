// Meowify content script - v10 offset-based replace
(() => {
  ...
  function openModal(mode) {
    ...
    card.append(head, body, foot); ov.appendChild(card); ov.onclick = e => { if (e.target === ov) ov.remove(); }; document.body.appendChild(ov);
  }
